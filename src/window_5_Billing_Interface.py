...
root.title("CheckOut Pad")

frame = Frame(root,width=650,height=70,relief=RIDGE,borderwidth=5,bg='#248aa2')
frame.place(x=0,y=0)

l1 = Label(frame,text="CheckOut Pad",font=('roboto',30,'bold'),bg='#248aa2',fg="#ffffff")
l1.place(x=10,y=4)
...
bill_details = ScrolledText(innerframe4,width=23,height=8,relief=SUNKEN,borderwidth=3,font=('courier',9,''))
